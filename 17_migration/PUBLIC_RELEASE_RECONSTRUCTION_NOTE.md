...
**Public milestone:** Release 01 — Foundation and Scope Formation
...
These additions must not be interpreted as evidence that the release-management files themselves existed at the original historical date.

The original v1-v5 lineage remains documented in the project version history.
